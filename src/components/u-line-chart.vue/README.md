...
<template>
<div>
	<u-line-chart border fill legend smooth :title="title" :x-axis="xaxis" :colors="colors" :y-axis="yaxis" :series="series" :data="data">
		<div slot-scope="scope" slot="tooltip">
			{{ scope.sery.name}} : {{ scope.row[scope.sery.key]}}
		</div>
	</u-line-chart>
		...
		return {
            ...
            colors: [
                (ctx) => {
                    ...
                    gradient.addColorStop(1,"#F3E7EC");
                    return {
                        fill: gradient,
                        stroke: "#FF8080"
                    };
                ...
                (ctx) => {
                    const gradient = ctx.createLinearGradient(0,0, 0, 480)
                    gradient.addColorStop(0,"#8AABFF");
                    gradient.addColorStop(1,"#DDE5F9");
                    return {
                        fill: gradient,
                        stroke: "#8AABFF"
                    };
