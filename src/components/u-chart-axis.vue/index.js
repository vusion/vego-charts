...
export const UChartAxis = {
    ...
    computed: {
        ...
        focus() {
            ...
            const i1 = bisectLeft(columns, xm, 1);
            const i0 = i1 - 1;
    ...
    mounted() {
        ...
        this.x = scaleTime().range(spaceXRange);
        this.x.domain(dataXRange);

        this.y = scaleLinear().range(spaceYRange);
